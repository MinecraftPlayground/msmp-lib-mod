 ...
 *
 * <p>Instances are created via {@link MSMPNamespace#notification(String)} and are registered
 ...
 *
 * <pre>{@code
 * MSMPNotification<PingPayload> ping = NS.notification("ping")
...
public final class MSMPNotification<Payload> {
    ...
    public MSMPNotification(String namespace, String name, Schema<Payload> schema, String description) {

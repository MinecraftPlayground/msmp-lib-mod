 ...
 *     NS.notification("ping", PingPayload.SCHEMA, "Sends a ping to all clients");
 * }</pre>
 *
...
public final class MSMPNotification<Payload> {
     ...
     *
     * @param namespace The namespace to register this notification under (e.g. {@code "entity_data"})
